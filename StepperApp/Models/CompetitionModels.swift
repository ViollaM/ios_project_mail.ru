...
var allCompetitions = [
    CompetitionData(name: "Daily step competition", maxValue: 1000, remainingTime: currentTime(), currentLeader: "@max", text: "Try to complete 10.000 steps today", isStepsCompetition: true),
